...
namespace mPOSv2.ViewModels
{
    public class CustomerViewModel : ViewModelBase
    {
        ...
        public void Load(object sender = null)
        {
            ...
            Task.Run(async () =>
            {
                MstCustomerFilter customerFilter = null;
                ...
                Customers = await ApiRequest<MstCustomerFilter, ObservableCollection<MstCustomer>>
        ...
        public MstCustomer SelectedCustomer { get; set; }
        ...
        {
            get => _RefreshSelectedCustomer ??
                   (_RefreshSelectedCustomer = new Command(ExecuteRefreshSelectedCustomer, () => true));
        ...
        private void ExecuteAdd(object sender)
        {
            ...
            Device.BeginInvokeOnMainThread(async () =>
                await Application.Current.MainPage.Navigation.PushAsync(new CustomerDetailView(this)));
        }
        ...
        private void ExecuteSave()
        {
            ...
            Task.Run(async () =>
            {
                ...
                SelectedCustomerId = await ApiRequest<MstCustomer, MstCustomer>
                    ...
                    .ContinueWith(x =>
                        {
                            if (x.Result)
                            {
                                ...
                                Task.Run(async () =>
                                {
                                    ...
                                    await ApiRequest<MstCustomer, MstCustomer>
